...
// 런처에서 메시지 수신
chrome.runtime.onMessage.addListener((request: NavigateRequest, sender, _sendResponse) => {
...
// 탭 전환 또는 네비게이션 처리
async function handleNavigateOrSwitch(request: NavigateRequest, launcherTab: chrome.tabs.Tab): Promise<void> {
